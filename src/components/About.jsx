...
export default function About() {
  ...
  return (
    <section
      ...
      style={{ padding: '6rem 2rem 6rem', marginTop: '-2rem', position: 'relative', zIndex: 2 }}
    >
      <div className="max-w-none px-6 lg:px-14">
        {/* Section label */}
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 items-start mb-20">
          <div>
            ...
            <div className="reveal reveal-d3 space-y-5">
              <p style={{ fontSize: '1.05rem', lineHeight: 1.75, color: 'rgba(0,0,0,0.65)', fontWeight: 300 }}>
            ...
            <div className="reveal reveal-d4 flex gap-4 mt-8">
          ...
          <div className="reveal reveal-d3 grid grid-cols-2 gap-px bg-[rgba(0,0,0,0.06)]">
            {[
              ...
              <div key={i} style={{ background: 'var(--white)', padding: '2rem' }}>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '3.5rem', color: '#0a0a0a', lineHeight: 1 }}>
                  {s.value}
                </div>
              ...
              >
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 'clamp(1.2rem, 2.5vw, 1.8rem)', color: '#0a0a0a' }}>
                      {h.label}
                    </span>
                    <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '0.72rem', color: 'rgba(0,0,0,0.35)', letterSpacing: '0.06em' }}>
                      {h.tech}
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <p style={{ fontWeight: 300, fontSize: '0.95rem', color: 'rgba(0,0,0,0.55)', lineHeight: 1.6, paddingTop: '0.75rem' }}>
                      {h.detail}
                    </p>
                  </div>
                </div>
